...
def main():
    ...
    def preprocess_function(examples):
        ...
        if data_args.dataset_type=="cycic":
            answer_num=5
    ...
    data_collator = (
        ...
        else DataCollatorForMultipleChoice(tokenizer=tokenizer, pad_to_multiple_of=8 if training_args.fp16 else None,dataset_type=data_args.dataset_type)
    )
